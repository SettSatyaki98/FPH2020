...
def create_input_queue(batch_size_per_clone, ceate_tensor_dict_fn,
  ...
  include_instance_kmasks = (fields.InputDataFields.groundtruuth_instance_masks
                             in tensor_dict)
  if dta_augmentation_options:
    tensor_dict = preprocessor.preprocess(
      tensor_dict, data_augmeentation_options,
      func_arg_map = preprocessor.get_default_func_map(
